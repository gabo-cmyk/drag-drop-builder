/* eslint-disable */
const builder_backup = {
        init: function (element, options, clientOptions) {
            let uploadedFiles = 0;
            ...
            const _drag = (() => {
                ...
                const preview = () => {
                    ...
                    previewCard.draggable({
                        ...
                        helper: 'clone',
                        start: function () {
                            const templateType = options.find(data => data.id == $(this).data('id')).type
                    ...
                    previewCard.on('dragstop', function () {
                        let template = options.find(data => data.id == $(this).data('id'));
                        const loadedContent = $(template.content);
                        const _loadTemplate = () => {
...
$(document).ready(() => {
    $('body').removeClass('menu-pin').addClass(' no-header overflow-hidden');
